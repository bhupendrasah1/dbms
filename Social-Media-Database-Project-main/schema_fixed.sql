-- Create database (if it doesn't exist in online editor, skip this part)
...
-- Add foreign keys for photos and videos
ALTER TABLE photos ADD CONSTRAINT fk_photos_post 
FOREIGN KEY(post_id) REFERENCES post(post_id);

ALTER TABLE videos ADD CONSTRAINT fk_videos_post 
FOREIGN KEY(post_id) REFERENCES post(post_id);
...
('jane_smith', 'jane@example.com', 'Travel blogger'),
